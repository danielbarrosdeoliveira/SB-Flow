...
| LP-PAGE-01 | Substituir `web/pages/index.vue` — importar todos componentes na ordem | LP-COMP-01 a LP-COMP-11 | Página renderiza todas as seções em SSR |
...
| ID | Check | Command |
|----|-------|---------|
| LP-GATE-01 | Build sem erros | `npm run build:web` |
| LP-GATE-02 | Typecheck | `npm run typecheck` |
